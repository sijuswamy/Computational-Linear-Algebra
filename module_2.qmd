...
Similarly we can use the standard scaling (transformation to normal distribution) using the transformation $\dfrac{x-\bar{x}}{\sigma}$. The python code for this operation is given below:
