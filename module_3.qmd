...
12.  What is the pseudo-inverse of a matrix? Write the Python code chunk to solve a system of linear equations $Ax = b$, where $A = \begin{bmatrix} 2 & 3 \\ -1 & 3 \\ 2 & 4 \end{bmatrix}$ and $b = \begin{bmatrix} 1 \\ 2 \\ 3 \end{bmatrix}$, using the pseudo-inverse. Justify the reason for using the pseudo-inverse instead of $A^{-1}$.   
